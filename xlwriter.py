...
class BasicInfoWriter(ExcelWriter):
    def __init__(self):
        super().__init__("excel_files/basic_info.xlsx")
...
class TaleOfSizeWriter(ExcelWriter):
    def __init__(self):
        super().__init__("excel_files/tale_size_info.xlsx")
...
class ReviewDataWriter(ExcelWriter):
    def __init__(self):
        super().__init__("excel_files/review_info.xlsx")
        self.row = 0
        self.col = 0
        worksheet = self.worksheet
    ...
    async def write_review_data(self, soup):
        ...
        try:
            ...
            (
                ...
                sense_of_fit_rating,
                comfort_rating,
            ) = await scraper.get_general_review_data()
